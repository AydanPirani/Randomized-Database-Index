...
\begin{center}
  \begin{figure}[H]
    \includegraphics[scale=0.42]{assets/randomized.png}
...
\begin{center}
  \begin{figure}[H]
    \includegraphics[scale=0.42]{assets/sequential.png}
...
\begin{center}
  \begin{figure}[H]
    \includegraphics[scale=0.42]{assets/cyclic.png}
...
\begin{center}
  \begin{figure}[H]
    \includegraphics[scale=0.42]{assets/reverse-repeat.png}
    \caption{Density plots of the indexes.}
  \end{figure}
\end{center}
\newpage
...
\begin{center}
  \begin{figure}[H]
    \includegraphics[scale=0.42]{assets/reverse-random.png}
    \caption{Density plots of the indexes.}
  \end{figure}
\end{center}
\newpage
